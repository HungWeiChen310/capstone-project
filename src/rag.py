...
class RAGKnowledgeBase:
    ...
    def _sync_database_documents(self) -> None:
        ...
        data_sources = [
            ...
            {
                "query": "SELECT equipment_id, year, month, total_operation_hrs, downtime_sec as total_abnormal_downtime_seconds, downtime_rate_percent as total_abnormal_rate_percent, notes as summary_notes FROM stats_operational_monthly",
                "table": "stats_operational_monthly",
                "source_tag": "StatsOperationalSummaryMonthly",
                "id_columns": ["equipment_id", "year", "month"],
                "text_columns": ["equipment_id", "year", "month", "total_operation_hrs", "total_abnormal_downtime_seconds", "total_abnormal_rate_percent", "summary_notes"],
            ...
            {
                "query": "SELECT equipment_id, year, quarter, total_operation_hrs, downtime_sec as total_abnormal_downtime_seconds, downtime_rate_percent as total_abnormal_rate_percent, notes as summary_notes FROM stats_operational_quarterly",
                "table": "stats_operational_quarterly",
                "source_tag": "StatsOperationalSummaryQuarterly",
                "id_columns": ["equipment_id", "year", "quarter"],
                "text_columns": ["equipment_id", "year", "quarter", "total_operation_hrs", "total_abnormal_downtime_seconds", "total_abnormal_rate_percent", "summary_notes"],
                "meta_columns": ["equipment_id", "year", "quarter"],
            },
            {
                "query": "SELECT equipment_id, year, total_operation_hrs, downtime_sec as total_abnormal_downtime_seconds, downtime_rate_percent as total_abnormal_rate_percent, notes as summary_notes FROM stats_operational_yearly",
                "table": "stats_operational_yearly",
                "source_tag": "StatsOperationalSummaryYearly",
                "id_columns": ["equipment_id", "year"],
                "text_columns": ["equipment_id", "year", "total_operation_hrs", "total_abnormal_downtime_seconds", "total_abnormal_rate_percent", "summary_notes"],
